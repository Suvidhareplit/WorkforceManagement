-- Migration: Add Remaining Exit Process Columns
-- Date: 2025-11-21
-- Description: Add remaining columns needed for exit initiation process

-- Add new columns (only the ones that don't exist yet)
